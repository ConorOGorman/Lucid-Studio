...
class F extends it {
  ...
  constructor(t) {
    ...
    ), this.code = this.name = F.code, this.data = { message: t };
  }
}
...
async function $n(n, t) {
  ...
  if (o = o.readUInt32BE(0), o !== 2)
    throw new F(`Invalid packfile version: ${o}`);
...
(function(n) {
  ...
  function B(u) {
    ...
    if (u.length !== void 0)
      return typeof u.length != "number" || Ut(u.length) ? f(0) : v(u);
  ...
  s.prototype.swap16 = function() {
    ...
    for (var m = g - p, S = l - a, $ = Math.min(m, S), k = this.slice(p, g), N = i.slice(a, l), T = 0; T < $; ++T)
      if (k[T] !== N[T]) {
        m = k[T], S = N[T];
        break;
      }
  ...
  function be(u, i, a, l, p) {
    ...
    if (p) {
      ...
      for (k = a; k < m; k++)
        if ($(u, k) === $(i, N === -1 ? 0 : k - N)) {
          if (N === -1 && (N = k), k - N + 1 === S) return N * g;
        } else
          N !== -1 && (k -= k - N), N = -1;
    } else
      for (a + S > m && (a = m - S), k = a; k >= 0; k--) {
        for (var T = !0, mt = 0; mt < S; mt++)
          if ($(u, k + mt) !== $(i, mt)) {
            T = !1;
            break;
          }
  ...
  function jr(u, i, a, l) {
    ...
    l > g / 2 && (l = g / 2);
    for (var m = 0; m < l; ++m) {
      var S = parseInt(i.substr(m * 2, 2), 16);
      if (Ut(S)) return m;
      u[a + m] = S;
    }
    return m;
      ...
      if (p + S <= a) {
        ...
        switch (S) {
          case 1:
            ...
            break;
          case 2:
            $ = u[p + 1], ($ & 192) === 128 && (T = (g & 31) << 6 | $ & 63, T > 127 && (m = T));
            break;
          case 3:
            $ = u[p + 1], k = u[p + 2], ($ & 192) === 128 && (k & 192) === 128 && (T = (g & 15) << 12 | ($ & 63) << 6 | k & 63, T > 2047 && (T < 55296 || T > 57343) && (m = T));
            break;
          case 4:
            $ = u[p + 1], k = u[p + 2], N = u[p + 3], ($ & 192) === 128 && (k & 192) === 128 && (N & 192) === 128 && (T = (g & 15) << 18 | ($ & 63) << 12 | (k & 63) << 6 | N & 63, T > 65535 && T < 1114112 && (m = T));
        }
      }
  ...
  s.prototype.writeUintLE = s.prototype.writeUIntLE = function(i, a, l, p) {
    ...
    var m = l - 1, S = 1;
    for (this[a + m] = i & 255; --m >= 0 && (S *= 256); )
      this[a + m] = i / S & 255;
    return a + l;
  }, s.prototype.writeUint8 = s.prototype.writeUInt8 = function(i, a, l) {
    return i = +i, a = a >>> 0, l || C(this, i, a, 1, 255, 0), this[a] = i & 255, a + 1;
  }, s.prototype.writeUint16LE = s.prototype.writeUInt16LE = function(i, a, l) {
    return i = +i, a = a >>> 0, l || C(this, i, a, 2, 65535, 0), this[a] = i & 255, this[a + 1] = i >>> 8, a + 2;
  }, s.prototype.writeUint16BE = s.prototype.writeUInt16BE = function(i, a, l) {
    return i = +i, a = a >>> 0, l || C(this, i, a, 2, 65535, 0), this[a] = i >>> 8, this[a + 1] = i & 255, a + 2;
  }, s.prototype.writeUint32LE = s.prototype.writeUInt32LE = function(i, a, l) {
    return i = +i, a = a >>> 0, l || C(this, i, a, 4, 4294967295, 0), this[a + 3] = i >>> 24, this[a + 2] = i >>> 16, this[a + 1] = i >>> 8, this[a] = i & 255, a + 4;
  }, s.prototype.writeUint32BE = s.prototype.writeUInt32BE = function(i, a, l) {
    return i = +i, a = a >>> 0, l || C(this, i, a, 4, 4294967295, 0), this[a] = i >>> 24, this[a + 1] = i >>> 16, this[a + 2] = i >>> 8, this[a + 3] = i & 255, a + 4;
    ...
    var m = 0, S = 1, $ = 0;
    for (this[a] = i & 255; ++m < l && (S *= 256); )
      i < 0 && $ === 0 && this[a + m - 1] !== 0 && ($ = 1), this[a + m] = (i / S >> 0) - $ & 255;
    return a + l;
    ...
    return i = +i, a = a >>> 0, l || C(this, i, a, 1, 127, -128), i < 0 && (i = 255 + i + 1), this[a] = i & 255, a + 1;
  }, s.prototype.writeInt16LE = function(i, a, l) {
    return i = +i, a = a >>> 0, l || C(this, i, a, 2, 32767, -32768), this[a] = i & 255, this[a + 1] = i >>> 8, a + 2;
  }, s.prototype.writeInt16BE = function(i, a, l) {
    return i = +i, a = a >>> 0, l || C(this, i, a, 2, 32767, -32768), this[a] = i >>> 8, this[a + 1] = i & 255, a + 2;
  }, s.prototype.writeInt32LE = function(i, a, l) {
    return i = +i, a = a >>> 0, l || C(this, i, a, 4, 2147483647, -2147483648), this[a] = i & 255, this[a + 1] = i >>> 8, this[a + 2] = i >>> 16, this[a + 3] = i >>> 24, a + 4;
  ...
  s.prototype.writeDoubleLE = function(i, a, l) {
    ...
    if (typeof i == "number")
      ...
      var S = s.isBuffer(i) ? i : s.from(i, p), $ = S.length;
      if ($ === 0)
...
var Hi = function n(t) {
  ...
  for (var d = 1, w = !0; d < r.length; d += 1) {
    ...
    if ((b === "constructor" || !w) && (h = !0), o += "." + b, f = "%" + o + "%", xt(Y, f))
      ...
      if (at && d + 1 >= r.length) {
        var U = at(s, b);
        w = !!U, w && "get" in U && !("originalValue" in U.get) ? s = U.get : s = s[b];
      } else
        w = xt(s, b), s = s[b];
      w && !h && (Y[f] = s);
    }
...
function Qi() {
  ...
  }, s = Object.prototype.toString, h = "[object Object]", y = "[object Function]", d = "[object GeneratorFunction]", w = "[object HTMLAllCollection]", b = "[object HTML document.all class]", v = "[object HTMLCollection]", _ = typeof Symbol == "function" && !!Symbol.toStringTag, U = !(0 in [,]), B = function() {
    return !1;
  };
  if (typeof document == "object") {
    var x = document.all;
    s.call(x) === s.call(document.all) && (B = function(E) {
      if ((U || !E) && (typeof E > "u" || typeof E == "object"))
        try {
          var P = s.call(E);
          return (P === w || P === b || P === v || P === h) && E("") == null;
        } catch {
        }
      return !1;
    });
...
function fo() {
  ...
  s && o && c ? n(y, function(U) {
    var B = new h[U]();
    if (Symbol.toStringTag in B && c) {
      var x = c(B), I = o(x, Symbol.toStringTag);
      if (!I && x) {
        var E = c(x);
        I = o(E, Symbol.toStringTag);
      }
      b["$" + U] = e(I.get);
    }
  }) : n(y, function(U) {
    var B = new h[U](), x = B.slice || B.set;
    x && (b[
  ...
  var v = function(B) {
    ...
    return n(
      ...
      function(I, E) {
        if (!x)
          try {
            "$" + I(B) === E && (x = /** @type {import('.').TypedArrayName} */
            d(E, 1));
          } catch {
          }
      }
    ...
    return n(
      ...
      function(I, E) {
        if (!x)
          try {
            I(B), x = /** @type {import('.').TypedArrayName} */
            d(E, 1);
          } catch {
          }
      }
...
It.prototype.digest = function(n) {
...
class nt {
  ...
  async read({ oid: t }) {
    if (!this.offsets.get(t)) {
      ...
      throw new F(`Could not read object ${t} from packfile`);
    }
...
class _t extends it {
  ...
  constructor(t, e, r, o) {
    ...
    ), this.code = this.name = _t.code, this.data = { oid: t, actual: e, expected: r, filepath: o };
  }
}
...
class J {
  ...
  static async fromBuffer(t) {
    ...
    if (o !== "DIRC")
      throw new F(`Invalid dircache magic file number: ${o}`);
