...
import { cloneStreamMonitorProgress as zr, cloneResponseMonitorProgress as Vr, ProgressTracker as Hr } from "@php-wasm/progress";
import { randomFilename as sr, phpVars as cr, joinPaths as ie, phpVar as we, dirname as Qr, Semaphore as Er } from "@php-wasm/util";
import { writeFiles as mr, LatestSupportedPHPVersion as Yr, SupportedPHPVersions as Zr } from "@php-wasm/universal";
import { resolveCommitHash as Gr, listGitFiles as Jr, listDescendantFiles as Kr, sparseCheckout as Xr, createDotGitDirectory as et, GitAuthenticationError as Pr, OverlayFilesystem as rt, InMemoryFilesystem as tt, FetchFilesystem as st, ZipFilesystem as it } from "@wp-playground/storage";
import { fetchWithCorsProxy as ot } from "@php-wasm/web";
import { encodeZip as at, collectFile as nt, StreamedFile as pt } from "@php-wasm/stream-compression";
import { logger as ae } from "@php-wasm/logger";
import { defineWpConfigConstants as lt, ensureWpConfig as ft } from "@wp-playground/wordpress";
import { unzipFile as $r, RecommendedPHPVersion as ut } from "@wp-playground/common";
function jr(r) {
...
class ir {
  static async create(t) {
    const n = await dt(t), f = jr(t) ? t : void 0;
    return ir.createFromDeclaration(n, f);
  }
...
const ct = `Blueprint resource of type "bundled" requires a filesystem.
...
class lr extends Error {
  constructor(t, n, f) {
    super(t, f), this.name = "ResourceDownloadError", this.url = n;
  }
}
const yt = [
  "vfs",
...
function ht(r) {
  return r && typeof r == "object" && typeof r.resource == "string" && yt.includes(r.resource);
}
function gt(r) {
  try {
...
function bt(r) {
  ...
  const f = t.searchParams, u = f.get("repo");
  if (!u)
    return null;
  const s = f.get("release"), e = f.get("asset");
  if (s && e) {
    const E = s === "latest" ? "releases/latest/download" : `releases/download/${s}`;
    return {
      resource: "url",
      url: `https://github.com/${u}/${E}/${e}`
    };
  }
  let p, d;
  const y = f.get("pr"), T = f.get("commit"), v = f.get("branch");
  y ? p = `refs/pull/${y}/head` : T ? (p = T, d = "commit") : s ? (p = s, d = "tag") : p = v || "HEAD";
...
class be {
  ...
  static create(t, {
    ...
    return n && (p = new At(p, n)), new qt(p);
  }
}
class qr extends be {
  constructor(t) {
...
class yr extends be {
  ...
  async resolve() {
    ...
    try {
      ...
      if (s = await Vr(
        s,
        ((u = this.progress) == null ? void 0 : u.loadingListener) ?? _t
      ), s.status !== 200)
        throw new lr(
          `Could not download "${t}"`,
          t
...
class Ot extends be {
  ...
  async resolve() {
    var f, u, s;
    const t = ((u = (f = this.options) == null ? void 0 : f.additionalHeaders) == null ? void 0 : u.call(f, this.reference.url)) ?? {}, n = (s = this.options) != null && s.corsProxy ? `${this.options.corsProxy}${this.reference.url}` : this.reference.url;
    try {
      const e = await Gr(
        n,
        {
   ...
   */
  get filename() {
    return this.name.replaceAll(/[^a-zA-Z0-9-.]/g, "-").replaceAll(/-+/g, "-").replace(/^[^a-zA-Z0-9]+|[^a-zA-Z0-9]+$/g, "") || sr();
  }
  /** @inheritDoc */
  get name() {
    var t;
...
class $t extends yr {
  ...
  getURL() {
    return `https://downloads.wordpress.org/theme/${Ar(this.resource.slug)}`;
  }
}
class jt extends yr {
  constructor(t, n) {
  ...
  /** @inheritDoc */
  getURL() {
    return `https://downloads.wordpress.org/plugin/${Ar(this.resource.slug)}`;
  }
}
function Ar(r) {
...
class St extends be {
  ...
  async resolve() {
    ...
    let n;
    t instanceof File ? n = [t] : n = Lt(t.files, t.name);
    const f = at(n), u = await nt(this.name, f);
...
const Rr = async (r, { pluginPath: t, pluginName: n }, f) => {
...
}, Sr = async (r, { themeFolderName: t }, n) => {
...
}, Nt = async (r, { options: t }) => await r.run(t), dr = async (r, { path: t }) => {
...
class WP_MySQL_Naive_Query_Stream {
  ...
  const f = `/tmp/${sr()}.sql`, u = `/tmp/${sr()}.php`;
  await r.writeFile(
    f,
    new Uint8Array(await t.arrayBuffer())
  ), await r.writeFile(
    u,
    new TextEncoder().encode(xt)
  );
  const s = await r.documentRoot, e = cr({ docroot: s, sqlFilename: f, streamClassFilename: u }), p = await r.run({
    code: `<?php
  ...
  return await dr(r, { path: f }), await dr(r, { path: u }), p;
}, Dt = async (r, { request: t }) => {
  ae.warn(
  ...
  return n;
}, hr = async (r, { consts: t, method: n = "define-before-run" }) => {
  switch (n) {
...
const Lr = async (r, { options: t }) => {
  const n = await r.documentRoot;
  await r.run({
    code: `<?php
		include ${we(n)} . '/wp-load.php';
		$site_options = ${we(t)};
...
}, It = async (r, { meta: t, userId: n }) => {
  const f = await r.documentRoot;
  await r.run({
    code: `<?php
		include ${we(f)} . '/wp-load.php';
		$meta = ${we(t)};
		foreach($meta as $name => $value) {
			update_user_meta(${we(n)}, $name, $value);
		}
		`
  });
}, gr = "/tmp/wp-cli.phar", Wt = {
  resource: "url",
  /**
...
}, Nr = async (r, { command: t, wpCliPath: n = gr }) => {
  await Fr(r, n);
  let f;
  if (typeof t == "string" ? (t = t.trim(), f = Mt(t)) : f = t, f.shift() !== "wp")
...
function Mt(r) {
  ...
  for (let p = 0; p < r.length; p++) {
    const d = r[p];
    f === 0 ? d === '"' || d === "'" ? (f = 1, u = d) : d.match(/\s/) ? (e && s.push(e), e = "") : e += d : f === 1 && (d === "\\" ? (p++, e += r[p]) : d === u ? (f = 0, u = "") : e += d);
  }
  return e && s.push(e), s;
}
const Bt = async (r, { wpCliPath: t }) => {
  await Fr(r, t), await hr(r, {
    consts: {
...
}, zt = async (r, { fromPath: t, toPath: n }) => {
...
}, Yt = async (r, { writeToPath: t, filesTree: n }) => {
  t.startsWith("/") || (ae.error(
    `
...
This will ensure your code works reliably regardless of the current working directory.
		`.trim()
  ), t = `/${t}`), await mr(r, t, n.files);
}, xr = async (r, { siteUrl: t }) => {
  await hr(r, {
    consts: {
      WP_HOME: t,
      WP_SITEURL: t
...
async function Gt(r, t, n) {
  var f;
  (f = n == null ? void 0 : n.tracker) == null || f.setCaption("Importing content"), await br(r, {
    path: "/tmp/import.wxr",
    data: t
  }), await r.run({
    $_SERVER: {
...
const Cr = async (r, { themeSlug: t = "" }, n) => {
  var u;
  ...
  await r.run({
    code: `<?php
		...
		function importThemeStarterContent_plugins_loaded() {
			...
			$_REQUEST['customize_theme'] = ${we(t)} ?: get_stylesheet();
...
}, wr = async (r, { zipFile: t, zipPath: n, extractToPath: f }) => {
  if (n)
    ae.warn(
...
], Jt = async (r, { wordPressFilesZip: t, pathInZip: n = "" }) => {
  const f = await r.documentRoot;
  let u = ie("/tmp", "import");
  await r.mkdir(u), await wr(r, {
    zipFile: t,
    extractToPath: u
  }), u = ie(u, n);
  ...
  if (await r.fileExists(s))
    try {
      const q = await r.readFileAsText(s);
      e = JSON.parse(q).siteUrl, await r.unlink(s);
    } catch {
    }
  const p = ie(u, "wp-content"), d = ie(f, "wp-content");
  for (const q of Dr) {
    const E = ie(
      p,
      q
    ...
    await kr(r, E);
    const h = ie(d, q);
    await r.fileExists(h) && (await r.mkdir(Qr(E)), await r.mv(h, E));
  }
  const y = ie(
    u,
    "wp-content",
  ...
  const T = await r.listFiles(u);
  for (const q of T)
    await kr(r, ie(f, q)), await r.mv(
      ie(u, q),
      ie(f, q)
    );
  await r.rmdir(u), await ft(r, f);
  const v = await r.absoluteUrl;
  e || (e = await Xt(r, f)), await xr(r, {
    siteUrl: v
  });
  const k = we(
  ...
  await r.run({
    code: `<?php
            ...
            require ${k};
            `
  }), e && e !== v && await Kt(r, f, e, v);
};
function _r(r) {
  const t = r.match(/\/scope:[^/]+\/?/);
  return t ? t[0].replace(/\/?$/, "/") : null;
}
async function Kt(r, t, n, f) {
  const u = _r(n), s = _r(f);
  !u || !s || u !== s && await r.run({
    code: `<?php
...
async function Ur(r, {
  ...
  const e = n.name.replace(/\.zip$/, ""), p = ie(await r.documentRoot, "wp-content"), d = ie(p, sr()), y = ie(d, "assets", e);
  ...
  try {
    ...
    let T = await r.listFiles(y, {
      prependPath: !0
    });
    T = T.filter((h) => !h.endsWith("/__MACOSX"));
    const v = T.length === 1 && await r.isDir(T[0]);
    let k, q = "";
    v ? (q = T[0], k = T[0].split("/").pop()) : (q = y, k = e), u && u.length && (k = u);
    const E = `${t}/${k}`;
    if (await r.fileExists(E)) {
      if (!await r.isDir(E))
        throw new Error(
          `Cannot install asset ${k} to ${E} because a file with the same name already exists. Note it's a file, not a directory! Is this by mistake?`
        );
      if (f === "overwrite")
        await r.rmdir(E, {
          recursive: !0
        ...
        throw new Error(
          `Cannot install asset ${k} to ${t} because it already exists and the ifAlreadyInstalled option was set to ${f}`
        );
      }
    }
    return await r.mv(q, E), {
      assetFolderPath: E,
      assetFolderName: k
    };
  } finally {
...
const rs = async (r, { pluginData: t, pluginZipFile: n, ifAlreadyInstalled: f, options: u = {} }, s) => {
  n && (t = n, ae.warn(
  ...
  const T = async (k) => {
    if (k.name.toLowerCase().endsWith(".zip"))
      return !0;
    const q = new Uint8Array(await k.arrayBuffer(), 0, 4);
    return q[0] === 80 && q[1] === 75 && q[2] === 3 && q[3] === 4;
  };
  if (t instanceof File)
    if (await T(t)) {
      const k = t.name.split("/").pop() || "plugin.zip";
      y = or(k), s == null || s.tracker.setCaption(
      ...
      d = q.assetFolderPath, y = q.assetFolderName;
    ...
    await mr(r, k, t.files, {
      rmRoot: !0
    }), d = k;
  }
  ("activate" in u ? u.activate : !0) && await Rr(
    r,
    {
      pluginPath: d,
      pluginName: y
...
}, ts = async (r, { themeData: t, themeZipFile: n, ifAlreadyInstalled: f, options: u = {} }, s) => {
  n && (t = n, ae.warn(
  ...
  let p = "", d = "";
  if (t instanceof File) {
    const v = t.name.split("/").pop() || "theme.zip";
    d = or(v), s == null || s.tracker.setCaption(`Installing the ${d} theme`), p = (await Ur(r, {
      ifAlreadyInstalled: f,
      zipFile: t,
    ...
    await mr(r, v, t.files, {
      rmRoot: !0
    });
  }
  ("activate" in u ? u.activate : !0) && await Sr(
    r,
    {
      themeFolderName: p
    },
    s
  ), ("importStarterContent" in u ? u.importStarterContent : !1) && await Cr(
    r,
    {
      themeSlug: p
    },
  ...
  const n = "/tmp/wordpress-playground.zip", f = "/tmp/playground-export.json", u = await r.documentRoot, s = ie(u, "wp-content"), e = await r.absoluteUrl;
  await r.writeFile(
    f,
    new TextEncoder().encode(JSON.stringify({ siteUrl: e }))
  );
  let p = Dr;
  t && (p = p.filter((v) => !v.startsWith("themes/twenty")).filter(
    (v) => v !== "mu-plugins/sqlite-database-integration"
  ));
  const d = {
  ...
  const T = await r.readFileAsBuffer(n);
  return r.unlink(n), r.unlink(f), T;
}, ns = `<?php
...
const ls = async (r, t) => {
  ...
  for (const { slug: k, version: q } of p)
    s.push({
      url: `https://downloads.wordpress.org/translation/plugin/${k}/${q}/${t}.zip`,
      type: "plugin"
    });
  const y = (await r.run({
    code: `<?php
  ...
  for (const { slug: k, version: q } of y)
    s.push({
      url: `https://downloads.wordpress.org/translation/theme/${k}/${q}/${t}.zip`,
      type: "theme"
    });
  ...
  const T = new Er({ concurrency: 5 }), v = s.map(
    ({ url: k, type: q }) => T.run(async () => {
      try {
        const E = await fetch(k);
        if (!E.ok)
          throw new Error(
            `Failed to download translations for ${q}: ${E.statusText}`
          );
        let h = `${f}/wp-content/languages`;
        q === "plugin" ? h += "/plugins" : q === "theme" && (h += "/themes"), await $r(
          r,
          new File(
            [await E.blob()],
            `${t}-${q}.zip`
        ...
        ae.warn(
          `Error downloading translations for ${q}: ${E}`
        );
      }
    })
  );
  ...
  enableMultisite: Bt,
  exportWXR: es,
  importThemeStarterContent: Cr,
  importWordPressFiles: Jt,
  importWxr: Zt,
  installPlugin: rs,
  installTheme: ts,
  login: ss,
...
}, Ir = Object.prototype.hasOwnProperty, fr = { validate: Z }, ys = {
  enum: ["branch", "tag", "commit", "refname"]
};
function de(r, { instancePath: t = "", parentData: n, parentDataProperty: f, rootData: u = r } = {}) {
  let s = null, e = 0;
...
function xe(r, { instancePath: t = "", parentData: n, parentDataProperty: f, rootData: u = r } = {}) {
  let s = null, e = 0;
  if (e === 0)
    if (r && typeof r == "object" && !Array.isArray(r))
      for (const y in r) {
        ...
        ur.validate(T, {
          ...
          rootData: u
        }) || (s = s === null ? ur.validate.errors : s.concat(ur.validate.errors), e = s.length);
        var p = E === e;
        if (q = q || p, !q) {
          const h = e;
          if (!(T && typeof T == "object" && !Array.isArray(T)) && typeof T != "string") {
            const K = {
              instancePath: t + "/" + y.replace(/~/g, "~0").replace(/\//g, "~1"),
              schemaPath: "#/additionalProperties/anyOf/1/type",
              keyword: "type",
              params: {
                type: hs.additionalProperties.anyOf[1].type
              },
        ...
        if (q)
          ...
          return s === null ? s = [h] : s.push(h), e++, xe.errors = s, !1;
        }
        var d = v === e;
        if (!d)
          break;
...
function $e(r, { instancePath: t = "", parentData: n, parentDataProperty: f, rootData: u = r } = {}) {
  let s = null, e = 0;
  if (e === 0)
    if (r && typeof r == "object" && !Array.isArray(r)) {
      let d;
...
function ce(r, { instancePath: t = "", parentData: n, parentDataProperty: f, rootData: u = r } = {}) {
  let s = null, e = 0;
  const p = e;
  let d = !1;
  const y = e;
  ...
  if (d)
    ...
    return s === null ? s = [v] : s.push(v), e++, ce.errors = s, !1;
  }
  return ce.errors = s, e === 0;
}
function ve(r, { instancePath: t = "", parentData: n, parentDataProperty: f, rootData: u = r } = {}) {
  let s = null, e = 0;
  if (e === 0)
    if (r && typeof r == "object" && !Array.isArray(r)) {
      let y;
          ...
          if (p) {
            if (r.inner !== void 0) {
              ...
              fr.validate(v, {
                ...
                rootData: u
              }) || (s = s === null ? fr.validate.errors : s.concat(
                fr.validate.errors
              ), e = s.length);
              var d = h === e;
              if (E = E || d, !E) {
              ...
              if (E)
                e = q, s !== null && (q ? s.length = q : s = null);
              else {
                const K = {
                  instancePath: t + "/inner",
                ...
                return s === null ? s = [K] : s.push(K), e++, ve.errors = s, !1;
              }
              var p = k === e;
            } else
              var p = !0;
...
function Z(r, { instancePath: t = "", parentData: n, parentDataProperty: f, rootData: u = r } = {}) {
  let s = null, e = 0;
  const p = e;
  let d = !1;
  const y = e;
    ...
    if (e === e)
      if (r && typeof r == "object" && !Array.isArray(r)) {
        ...
        if (r.resource === void 0 && (N = "resource") || r.name === void 0 && (N = "name") || r.contents === void 0 && (N = "contents")) {
          ...
          const b = e;
          for (const w in r)
            if (!(w === "resource" || w === "name" || w === "contents")) {
              const O = {
                instancePath: t,
                  ...
                  if (P = P || E, !P) {
                    ...
                    if (e === L)
                      if (w && typeof w == "object" && !Array.isArray(w)) {
                        let F;
                        if (w.BYTES_PER_ELEMENT === void 0 && (F = "BYTES_PER_ELEMENT") || w.buffer === void 0 && (F = "buffer") || w.byteLength === void 0 && (F = "byteLength") || w.byteOffset === void 0 && (F = "byteOffset") || w.length === void 0 && (F = "length")) {
                          const I = {
                            instancePath: t + "/contents",
                              ...
                              if (w.buffer !== void 0) {
                                ...
                                if (e === U)
                                  if (D && typeof D == "object" && !Array.isArray(
                                    ...
                                    let S;
                                    if (D.byteLength === void 0 && (S = "byteLength")) {
                                      const H = {
  ...
  if (d)
    ...
    return s === null ? s = [W] : s.push(W), e++, Z.errors = s, !1;
  }
  return Z.errors = s, e === 0;
}
const rr = {
  oneOf: [
    {
  ...
  if (e === 0)
    if (r && typeof r == "object" && !Array.isArray(r)) {
        ...
        ], !1;
      {
        const Q = e;
        for (const j in r)
          if (!(j === "method" || j === "url" || j === "headers" || j === "body"))
            return ge.errors = [
              {
                instancePath: t,
                schemaPath: "#/additionalProperties",
        ...
        if (Q === e) {
          if (r.method !== void 0) {
            ...
            if (!(j === "GET" || j === "POST" || j === "HEAD" || j === "OPTIONS" || j === "PATCH" || j === "PUT" || j === "DELETE"))
              return ge.errors = [
                {
                  instancePath: t + "/method",
                ...
                if (r.body !== void 0) {
                  ...
                  if (re = re || y, !re) {
                    ...
                    if (e === b)
                      if (j && typeof j == "object" && !Array.isArray(j)) {
                        let O;
                        if (j.BYTES_PER_ELEMENT === void 0 && (O = "BYTES_PER_ELEMENT") || j.buffer === void 0 && (O = "buffer") || j.byteLength === void 0 && (O = "byteLength") || j.byteOffset === void 0 && (O = "byteOffset") || j.length === void 0 && (O = "length")) {
                          const _ = {
                            instancePath: t + "/body",
                          ...
                          if (_ === e) {
                            if (j.BYTES_PER_ELEMENT !== void 0) {
                              let P = j.BYTES_PER_ELEMENT;
                              const g = e;
                            ...
                            if (C = C || k, !C) {
                              ...
                              if (e === I)
                                if (g && typeof g == "object" && !Array.isArray(
                                  ...
                                  let U;
                                  if (g.BYTES_PER_ELEMENT === void 0 && (U = "BYTES_PER_ELEMENT") || g.buffer === void 0 && (U = "buffer") || g.byteLength === void 0 && (U = "byteLength") || g.byteOffset === void 0 && (U = "byteOffset") || g.length === void 0 && (U = "length")) {
                                    const ee = {
                                      instancePath: t + "/body/" + P.replace(
                                        /~/g,
                                        "~0"
                              ...
                              if (C = C || k, !C) {
                                ...
                                if (e === U)
                                  if (g && typeof g == "object" && !Array.isArray(
                                    ...
                                    let S;
                                    if (g.lastModified === void 0 && (S = "lastModified") || g.name === void 0 && (S = "name") || g.size === void 0 && (S = "size") || g.type === void 0 && (S = "type") || g.webkitRelativePath === void 0 && (S = "webkitRelativePath")) {
                                      const H = {
                                        instancePath: t + "/body/" + P.replace(
                                          /~/g,
                                          "~0"
                  ...
                  if (re)
                    ...
                    return s === null ? s = [b] : s.push(b), e++, ge.errors = s, !1;
                  }
                  var p = X === e;
                } else
                  var p = !0;
          ...
          if (p) {
            ...
            if (p) {
              if (r.method !== void 0) {
                ...
                if (!(h === "GET" || h === "POST" || h === "HEAD" || h === "OPTIONS" || h === "PATCH" || h === "PUT" || h === "DELETE"))
                  return pe.errors = [
                    {
                      instancePath: t + "/method",
                      schemaPath: "#/definitions/HTTPMethod/enum",
                    ...
                    if (h && typeof h == "object" && !Array.isArray(h))
                      for (const j in h) {
                        ...
                        if (typeof h[j] != "string")
                          return pe.errors = [
                            {
                              instancePath: t + "/headers/" + j.replace(
                                /~/g,
                                "~0"
                              ).replace(
                                /\//g,
                  ...
                  if (r.body !== void 0) {
                    ...
                    if (Q = Q || y, !Q) {
                      ...
                      if (e === W)
                        if (h && typeof h == "object" && !Array.isArray(h)) {
                          let m;
                          if (h.BYTES_PER_ELEMENT === void 0 && (m = "BYTES_PER_ELEMENT") || h.buffer === void 0 && (m = "buffer") || h.byteLength === void 0 && (m = "byteLength") || h.byteOffset === void 0 && (m = "byteOffset") || h.length === void 0 && (m = "length")) {
                            const N = {
                              instancePath: t + "/body",
                              schemaPath: "#/properties/body/anyOf/1/required",
                              keyword: "required",
                                ...
                                if (h.buffer !== void 0) {
                                  ...
                                  if (e === w)
                                    if (b && typeof b == "object" && !Array.isArray(
                                      ...
                                      let _;
                                      if (b.byteLength === void 0 && (_ = "byteLength")) {
                                        const P = {
                                          instancePath: t + "/body/buffer",
                                          schemaPath: "#/properties/body/anyOf/1/properties/buffer/required",
                                          keyword: "required",
                    ...
                    if (E) {
                      ...
                      if (E) {
                        if (r.consts !== void 0) {
                          let i = r.consts;
                          const l = e;
                          if (e === l && !(i && typeof i == "object" && !Array.isArray(
                            i
                          )))
                            return o.errors = [
                              {
                              ...
                              return o.errors = [
                                {
                                  ...
                                  keyword: "enum",
                                  params: {
                                    allowedValues: rr.oneOf[3].properties.method.enum
                                  },
                                  message: "must be equal to one of the allowed values"
                                }
                              ], !1;
                              ...
                              return o.errors = [
                                {
                                  ...
                                  keyword: "enum",
                                  params: {
                                    allowedValues: rr.oneOf[6].properties.importer.enum
                                  },
                                  message: "must be equal to one of the allowed values"
                                }
                              ], !1;
                          ...
                          return o.errors = [
                            {
                              ...
                              keyword: "enum",
                              params: {
                                allowedValues: rr.oneOf[9].properties.ifAlreadyInstalled.enum
                              },
                              message: "must be equal to one of the allowed values"
                            }
                          ], !1;
                          ...
                          return o.errors = [
                            {
                              ...
                              keyword: "enum",
                              params: {
                                allowedValues: rr.oneOf[10].properties.ifAlreadyInstalled.enum
                              },
                              message: "must be equal to one of the allowed values"
                            }
                          ], !1;
                                          ...
                                          if (i.buffer !== void 0) {
                                            ...
                                            if (e === he)
                                              if (Y && typeof Y == "object" && !Array.isArray(
                                                ...
                                                let fe;
                                                if (Y.byteLength === void 0 && (fe = "byteLength")) {
                                                  const er = {
...
function V(r, { instancePath: t = "", parentData: n, parentDataProperty: f, rootData: u = r } = {}) {
  let s = null, e = 0;
  if (e === 0)
    if (r && typeof r == "object" && !Array.isArray(r)) {
      const re = e;
      for (const m in r)
        if (!Ir.call(ds.properties, m))
          return V.errors = [
            {
              instancePath: t,
              schemaPath: "#/additionalProperties",
            ...
            if (r.meta !== void 0) {
              ...
              if (e === N)
                if (m && typeof m == "object" && !Array.isArray(m)) {
                  let w;
                  if (m.title === void 0 && (w = "title") || m.author === void 0 && (w = "author"))
                    return V.errors = [
                      {
                        instancePath: t + "/meta",
                    ...
                    ], !1;
                  {
                    const O = e;
                    for (const _ in m)
                      if (!(_ === "title" || _ === "description" || _ === "author" || _ === "categories"))
                        return V.errors = [
                          {
                            instancePath: t + "/meta",
            ...
            if (p) {
              if (r.preferredVersions !== void 0) {
                ...
                if (e === N)
                  if (m && typeof m == "object" && !Array.isArray(m)) {
                    let w;
                    if (m.php === void 0 && (w = "php") || m.wp === void 0 && (w = "wp"))
                      return V.errors = [
                        {
                      ...
                      ], !1;
                    {
                      ...
                      if (O === e) {
                        if (m.php !== void 0) {
                          ...
                          if (!(_ === "8.5" || _ === "8.4" || _ === "8.3" || _ === "8.2" || _ === "8.1" || _ === "8.0" || _ === "7.4" || _ === "7.3" || _ === "7.2")) {
                            const C = {
                              instancePath: t + "/preferredVersions/php",
                              schemaPath: "#/definitions/SupportedPHPVersion/enum",
                              keyword: "enum",
                              params: {
                                allowedValues: cs.enum
                              },
                              message: "must be equal to one of the allowed values"
                            };
                            s === null ? s = [C] : s.push(C), e++;
                          ...
                          if (R)
                            ...
                            return s === null ? s = [C] : s.push(C), e++, V.errors = s, !1;
                          }
                          var v = P === e;
                        } else
                          var v = !0;
                      ...
                      if (e === e)
                        if (m && typeof m == "object" && !Array.isArray(m))
                          for (const O in m) {
                            let _ = m[O];
                            const P = e;
                            if (typeof _ != "string" && typeof _ != "boolean" && !(typeof _ == "number" && isFinite(_)))
                              return V.errors = [
                                {
                                  ...
                                  keyword: "type",
                                  params: {
                                    type: ms.additionalProperties.type
                                  },
                        ...
                        if (r.siteOptions !== void 0) {
                          ...
                          if (e === N)
                            if (m && typeof m == "object" && !Array.isArray(
                              ...
                              if (w === e && m.blogname !== void 0 && typeof m.blogname != "string")
                                return V.errors = [
                                  {
...
function tr(r, { instancePath: t = "", parentData: n, parentDataProperty: f, rootData: u = r } = {}) {
  let s = null, e = 0;
  return V(r, {
    instancePath: t,
    parentData: n,
    parentDataProperty: f,
    rootData: u
  }) || (s = s === null ? V.errors : s.concat(V.errors), e = s.length), tr.errors = s, e === 0;
}
const { wpCLI: bs, ...Or } = us, ws = {
  ...Or,
  "wp-cli": bs,
...
class Ps extends Error {
  constructor(t) {
    const { stepNumber: n, step: f, cause: u } = t, s = u instanceof Error ? u : new Error(String(u)), e = `Error when executing the blueprint step #${n}`, p = s.message ? `${e}: ${s.message}` : e;
...
async function _s(r, t = {}) {
  ...
  let f;
  return Mr(r) ? (f = await ks(r), n.streamBundledFile = function(...u) {
    return r.read(...u);
  }) : f = r, Os(f, n);
}
function Mr(r) {
...
function Os(r, {
  progress: t = new Hr(),
  semaphore: n = new Er({ concurrency: 3 }),
  onStepCompleted: f = () => {
  },
  ...
  var h, M, K, Q, j, X, W, re, m, N;
  r = structuredClone(r), r = {
    ...r,
    steps: (r.steps || []).filter(js).filter(qs)
  }, r.steps = [...r.steps || [], ...d || []];
  for (const b of r.steps)
    ...
    )) : (b == null ? void 0 : b.step) === "installPlugin" && "pluginZipFile" in b ? (b.pluginData = b.pluginZipFile, ae.warn(
      'The "pluginZipFile" option of the "installPlugin" step is deprecated. Use "pluginData" instead.'
    )) : (b == null ? void 0 : b.step) === "installTheme" && "themeZipFile" in b && (b.themeData = b.themeZipFile, ae.warn(
  ...
  if (r.constants && r.steps.unshift({
    ...
    const b = r.plugins.map((w) => typeof w == "string" ? w.startsWith("https://") ? {
      resource: "url",
      url: w
    } : {
  ...
  const y = ((h = r.steps) == null ? void 0 : h.findIndex(
    (b) => typeof b == "object" && (b == null ? void 0 : b.step) && ["wp-cli", "enableMultisite"].includes(b.step)
  )) ?? -1;
  if ((M = r == null ? void 0 : r.extraLibraries) != null && M.includes("wp-cli") || y !== -1) {
    ...
    y === -1 ? (K = r.steps) == null || K.push(b) : (Q = r.steps) == null || Q.splice(
      y,
      0,
      b
    );
  }
  const T = (j = r.steps) == null ? void 0 : j.findIndex(
    (b) => typeof b == "object" && (b == null ? void 0 : b.step) === "importWxr"
  );
  T !== void 0 && T > -1 && ((X = r.steps) == null || X.splice(T, 0, {
    step: "installPlugin",
    pluginData: {
      resource: "wordpress.org/plugins",
...
Please review your Blueprint and fix these issues. Learn more about the Blueprint format: https://wordpress.github.io/wordpress-playground/blueprints/data-format`,
  ...
  u(r);
  const k = r.steps || [], q = k.reduce(
    (b, w) => {
      var O;
      return b + (((O = w.progress) == null ? void 0 : O.weight) || 1);
    },
    0
  ), E = k.map(
    (b) => As(b, {
  ...
  return {
    ...
    run: async (b) => {
      try {
        for (const { resources: w } of E)
          for (const O of w)
            O.setPlayground(b), O.isAsync && O.resolve().catch(() => {
            });
        for (const [w, { run: O, step: _ }] of Object.entries(E))
          try {
            const P = await O(b);
            f(P, _);
          } catch (P) {
        ...
        try {
          const w = await b.pathToInternalUrl(r.landingPage || "/");
          await b.goTo(
            "/index.php?playground-redirection-handler&next=" + encodeURIComponent(w)
          );
        } catch {
        }
        t.finish();
    ...
    if (s.includes("must NOT have additional properties")) {
      ...
      if (d) {
        ...
        try {
          ...
          let T = r;
          for (const v of y)
            T && typeof T == "object" && (T = T[v]);
          if (T && typeof T == "object") {
            const v = T[d], k = JSON.stringify(v);
            e = `
  "${d}": ${k}
  ${"^".repeat(
              d.length + 2
      ...
      try {
        ...
        let y = r;
        for (const T of d)
          y && typeof y == "object" && (y = y[T]);
        if (y !== void 0) {
          const T = JSON.stringify(y, null, 2);
          e = `
  Value: ${T.length > 200 ? T.substring(0, 200) + "..." : T}`;
        }
      } catch {
      }
    return `${f + 1}. At path "${u}": ${s}${e}`;
  }).join(`
...
function As(r, {
  ...
  var q;
  const p = n.stage(
    (((q = r.progress) == null ? void 0 : q.weight) || 1) / f
  ), d = {};
  ...
  const y = async (E) => {
    var h;
    try {
      return p.fillSlowly(), await ws[r.step](
        E,
        await Rs(d),
        {
          tracker: p,
          initialCaption: (h = r.progress) == null ? void 0 : h.caption
        }
      );
    } finally {
      p.finish();
    }
  }, T = Tr(d), v = Tr(d).filter(
    (E) => E.isAsync
  ), k = 1 / (v.length + 1);
  for (const E of v)
    E.progress = p.stage(k);
  return { run: y, step: r, resources: T };
}
function Tr(r) {
  const t = [];
  for (const n in r) {
    const f = r[n];
    f instanceof be && t.push(f);
  }
  return t;
}
async function Rs(r) {
  ...
  for (const n in r) {
    const f = r[n];
    f instanceof be ? t[n] = await f.resolve() : t[n] = f;
  }
  return t;
}
...
async function Qs(r) {
  ...
  const d = await f.onMessage(async (k) => {
    try {
      const q = typeof k == "string" ? JSON.parse(k) : k;
      if (!q)
        return;
      await new Promise((E) => setTimeout(E, 0)), q.type.startsWith("blueprint.") && await u(q);
    } catch (q) {
      ae.warn("Failed to parse message as JSON:", k, q);
    }
  });
...
function playground_on_blueprint_resolved($blueprint) {
	$additional_blueprint_steps = json_decode(${we(
      JSON.stringify(((T = r.blueprintOverrides) == null ? void 0 : T.additionalSteps) || [])
    )}, true);
	...
	$wp_version_override = json_decode(${we(
      JSON.stringify(((v = r.blueprintOverrides) == null ? void 0 : v.wordpressVersion) || null)
    )}, true);
...
async function Zs(r) {
  if ((await ir.create(r)).getVersion() === 1) {
    const n = await _s(
      r
    );
    return {
...
export {
  Fs as BlueprintFetchError,
  mt as BlueprintFilesystemRequiredError,
  ir as BlueprintReflection,
  Ps as BlueprintStepExecutionError,
  vs as InvalidBlueprintError,
  lr as ResourceDownloadError,
  Rr as activatePlugin,
  Sr as activateTheme,
  _s as compileBlueprint,
  _s as compileBlueprintV1,
  zt as cp,
  xr as defineSiteUrl,
  hr as defineWpConfigConsts,
  Bt as enableMultisite,
  es as exportWXR,
  ks as getBlueprintDeclaration,
  Ss as getV2Runner,
  Cr as importThemeStarterContent,
  Jt as importWordPressFiles,
  Zt as importWxr,
  rs as installPlugin,
  ts as installTheme,
  Mr as isBlueprintBundle,
  js as isStepDefinition,
  ss as login,
  Ht as mkdir,
  Vt as mv,
  Dt as request,
  is as resetData,
  Ys as resolveRemoteBlueprint,
  Zs as resolveRuntimeConfiguration,
  dr as rm,
  Qt as rmdir,
  Hs as runBlueprintSteps,
  Hs as runBlueprintV1Steps,
  Qs as runBlueprintV2,
  Ft as runPHP,
  Nt as runPHPWithOptions,
  Ct as runSql,
  os as runWpInstallationWizard,
  Gs as setPluginProxyURL,
  fs as setSiteLanguage,
  Lr as setSiteOptions,
  wr as unzip,
  It as updateUserMeta,
  Es as validateBlueprint,
  Nr as wpCLI,
  Dr as wpContentFilesExcludedFromExport,
  br as writeFile,
  Yt as writeFiles,
  as as zipWpContent
};
