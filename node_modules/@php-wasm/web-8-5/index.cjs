...
// packages/php-wasm/web-builds/8-5/src/index.ts
var src_exports = {};
...
async function getIntlExtensionPath() {
  if (await (0, import_wasm_feature_detect.jspi)()) {
    return (await Promise.resolve().then(() => __toESM(require("./jspi/extensions/intl/8_5/intl.so?url"), 1))).default;
  } else {
    return (await Promise.resolve().then(() => __toESM(require("./asyncify/extensions/intl/8_5/intl.so?url"), 1))).default;
  }
}
