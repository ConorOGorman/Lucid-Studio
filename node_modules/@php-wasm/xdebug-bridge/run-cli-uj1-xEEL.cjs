...
`),s+=a.charAt(i);return e&&n&&(s=`${e}${s}${n}`),s}function Vs(a){return qs(a,{stringWidth:t=>[...t].length,stripAnsi:ts,wrap:Ws})}function Hs(a,t){let e=Ot.resolve(".",a),n;for($t.statSync(e).isDirectory()||(e=Ot.dirname(e));;){if(n=t(e,$t.readdirSync(e)),n)return Ot.resolve(e,n);if(e=Ot.dirname(n=e),n===e)break}}/**
 * @license
 ...
 * Copyright (c) 2016, Contributors
 * SPDX-License-Identifier: ISC
 */let qt;class Gs{constructor(t){qt=t}parse(t,e){const n=Object.assign({alias:void 0,array:void 0,boolean:void 0,config:void 0,configObjects:void 0,configuration:void 0,coerce:void 0,count:void 0,default:void 0,envPrefix:void 0,narg:void 0,normalize:void 0,string:void 0,number:void 0,__:void 0,key:void 0},e),s=zs(t),i=typeof t=="string",r=Ys(Object.assign(Object.create(null),n.alias)),o=Object.assign({"boolean-negation":!0,"camel-case-expansion":!0,"combine-arrays":!1,"dot-notation":!0,"duplicate-arguments-array":!0,"flatten-duplicate-arrays":!0,"greedy-arrays":!0,"halt-at-non-option":!1,"nargs-eats-options":!1,"negation-prefix":"no-","parse-numbers":!0,"parse-positional-numbers":!0,"populate--":!1,"set-placeholder-key":!1,"short-option-groups":!0,"strip-aliased":!1,"strip-dashed":!1,"unknown-options-as-args":!1},n.configuration),l=Object.assign(Object.create(null),n.default),E=n.configObjects||[],m=n.envPrefix,p=o["populate--"],b=p?"--":"_",w=Object.create(null),D=Object.create(null),_=n.__||qt.format,I={aliases:Object.create(null),arrays:Object.create(null),bools:Object.create(null),strings:Object.create(null),numbers:Object.create(null),counts:Object.create(null),normalize:Object.create(null),configs:Object.create(null),nargs:Object.create(null),coercions:Object.create(null),keys:[]},T=/^-([0-9]+(\.[0-9]+)?|\.[0-9]+)$/,C=new RegExp("^--"+o["negation-prefix"]+"(.+)");[].concat(n.array||[]).filter(Boolean).forEach(function(A){const f=typeof A=="object"?A.key:A,u=Object.keys(A).map(function(c){return{boolean:"bools",string:"strings",number:"numbers"}[c]}).filter(Boolean).pop();u&&(I[u][f]=!0),I.arrays[f]=!0,I.keys.push(f)}),[].concat(n.boolean||[]).filter(Boolean).forEach(function(A){I.bools[A]=!0,I.keys.push(A)}),[].concat(n.string||[]).filter(Boolean).forEach(function(A){I.strings[A]=!0,I.keys.push(A)}),[].concat(n.number||[]).filter(Boolean).forEach(function(A){I.numbers[A]=!0,I.keys.push(A)}),[].concat(n.count||[]).filter(Boolean).forEach(function(A){I.counts[A]=!0,I.keys.push(A)}),[].concat(n.normalize||[]).filter(Boolean).forEach(function(A){I.normalize[A]=!0,I.keys.push(A)}),typeof n.narg=="object"&&Object.entries(n.narg).forEach(([A,f])=>{typeof f=="number"&&(I.nargs[A]=f,I.keys.push(A))}),typeof n.coerce=="object"&&Object.entries(n.coerce).forEach(([A,f])=>{typeof f=="function"&&(I.coercions[A]=f,I.keys.push(A))}),typeof n.config<"u"&&(Array.isArray(n.config)||typeof n.config=="string"?[].concat(n.config).filter(Boolean).forEach(function(A){I.configs[A]=!0}):typeof n.config=="object"&&Object.entries(n.config).forEach(([A,f])=>{(typeof f=="boolean"||typeof f=="function")&&(I.configs[A]=f)})),_t(n.key,r,n.default,I.arrays),Object.keys(l).forEach(function(A){(I.aliases[A]||[]).forEach(function(f){l[f]=l[A]})});let g=null;ht();let v=[];const M=Object.assign(Object.create(null),{_:[]}),X={};for(let A=0;A<s.length;A++){const f=s[A],u=f.replace(/^-{3,}/,"---");let c,h,N,L,j,Z;if(f!=="--"&&/^-/.test(f)&&y(f))q(f);else if(u.match(/^---+(=|$)/)){q(f);continue}else if(f.match(/^--.+=/)||!o["short-option-groups"]&&f.match(/^-.+=/))L=f.match(/^--?([^=]+)=([\s\S]*)$/),L!==null&&Array.isArray(L)&&L.length>=3&&(K(L[1],I.arrays)?A=d(A,L[1],s,L[2]):K(L[1],I.nargs)!==!1?A=U(A,L[1],s,L[2]):B(L[1],L[2],!0));else if(f.match(C)&&o["boolean-negation"])L=f.match(C),L!==null&&Array.isArray(L)&&L.length>=2&&(h=L[1],B(h,K(h,I.arrays)?[!1]:!1));else if(f.match(/^--.+/)||!o["short-option-groups"]&&f.match(/^-[^-]+/))L=f.match(/^--?(.+)/),L!==null&&Array.isArray(L)&&L.length>=2&&(h=L[1],K(h,I.arrays)?A=d(A,h,s):K(h,I.nargs)!==!1?A=U(A,h,s):(j=s[A+1],j!==void 0&&(!j.match(/^-/)||j.match(T))&&!K(h,I.bools)&&!K(h,I.counts)||/^(true|false)$/.test(j)?(B(h,j),A++):B(h,P(h))));else if(f.match(/^-.\..+=/))L=f.match(/^-([^=]+)=([\s\S]*)$/),L!==null&&Array.isArray(L)&&L.length>=3&&B(L[1],L[2]);else if(f.match(/^-.\..+/)&&!f.match(T))j=s[A+1],L=f.match(/^-(.\..+)/),L!==null&&Array.isArray(L)&&L.length>=2&&(h=L[1],j!==void 0&&!j.match(/^-/)&&!K(h,I.bools)&&!K(h,I.counts)?(B(h,j),A++):B(h,P(h)));else if(f.match(/^-[^-]+/)&&!f.match(T)){N=f.slice(1,-1).split(""),c=!1;for(let nt=0;nt<N.length;nt++){if(j=f.slice(nt+2),N[nt+1]&&N[nt+1]==="="){Z=f.slice(nt+3),h=N[nt],K(h,I.arrays)?A=d(A,h,s,Z):K(h,I.nargs)!==!1?A=U(A,h,s,Z):B(h,Z),c=!0;break}if(j==="-"){B(N[nt],j);continue}if(/[A-Za-z]/.test(N[nt])&&/^-?\d+(\.\d*)?(e-?\d+)?$/.test(j)&&K(j,I.bools)===!1){B(N[nt],j),c=!0;break}if(N[nt+1]&&N[nt+1].match(/\W/)){B(N[nt],j),c=!0;break}else B(N[nt],P(N[nt]))}h=f.slice(-1)[0],!c&&h!=="-"&&(K(h,I.arrays)?A=d(A,h,s):K(h,I.nargs)!==!1?A=U(A,h,s):(j=s[A+1],j!==void 0&&(!/^(-|--)[^-]/.test(j)||j.match(T))&&!K(h,I.bools)&&!K(h,I.counts)||/^(true|false)$/.test(j)?(B(h,j),A++):B(h,P(h))))}else if(f.match(/^-[0-9]$/)&&f.match(T)&&K(f.slice(1),I.bools))h=f.slice(1),B(h,P(h));else if(f==="--"){v=s.slice(A+1);break}else if(o["halt-at-non-option"]){v=s.slice(A);break}else q(f)}V(M,!0),V(M,!1),W(M),k(),at(M,I.aliases,l,!0),ft(M),o["set-placeholder-key"]&&It(M),Object.keys(I.counts).forEach(function(A){ot(M,A.split("."))||B(A,0)}),p&&v.length&&(M[b]=[]),v.forEach(function(A){M[b].push(A)}),o["camel-case-expansion"]&&o["strip-dashed"]&&Object.keys(M).filter(A=>A!=="--"&&A.includes("-")).forEach(A=>{delete M[A]}),o["strip-aliased"]&&[].concat(...Object.keys(r).map(A=>r[A])).forEach(A=>{o["camel-case-expansion"]&&A.includes("-")&&delete M[A.split(".").map(f=>me(f)).join(".")],delete M[A]});function q(A){const f=$("_",A);(typeof f=="string"||typeof f=="number")&&M._.push(f)}function U(A,f,u,c){let h,N=K(f,I.nargs);if(N=typeof N!="number"||isNaN(N)?1:N,N===0)return rt(c)||(g=Error(_("Argument unexpected for: %s",f))),B(f,P(f)),A;let L=rt(c)?0:1;if(o["nargs-eats-options"])u.length-(A+1)+L<N&&(g=Error(_("Not enough arguments following: %s",f))),L=N;else{for(h=A+1;h<u.length&&(!u[h].match(/^-[^0-9]/)||u[h].match(T)||y(u[h]));h++)L++;L<N&&(g=Error(_("Not enough arguments following: %s",f)))}let j=Math.min(L,N);for(!rt(c)&&j>0&&(B(f,c),j--),h=A+1;h<j+A+1;h++)B(f,u[h]);return A+j}function d(A,f,u,c){let h=[],N=c||u[A+1];const L=K(f,I.nargs);if(K(f,I.bools)&&!/^(true|false)$/.test(N))h.push(!0);else if(rt(N)||rt(c)&&/^-/.test(N)&&!T.test(N)&&!y(N)){if(l[f]!==void 0){const j=l[f];h=Array.isArray(j)?j:[j]}}else{rt(c)||h.push(R(f,c,!0));for(let j=A+1;j<u.length&&!(!o["greedy-arrays"]&&h.length>0||L&&typeof L=="number"&&h.length>=L||(N=u[j],/^-/.test(N)&&!T.test(N)&&!y(N)));j++)A=j,h.push(R(f,N,i))}return typeof L=="number"&&(L&&h.length<L||isNaN(L)&&h.length===0)&&(g=Error(_("Not enough arguments following: %s",f))),B(f,h),A}function B(A,f,u=i){if(/-/.test(A)&&o["camel-case-expansion"]){const N=A.split(".").map(function(L){return me(L)}).join(".");S(A,N)}const c=R(A,f,u),h=A.split(".");ut(M,h,c),I.aliases[A]&&I.aliases[A].forEach(function(N){const L=N.split(".");ut(M,L,c)}),h.length>1&&o["dot-notation"]&&(I.aliases[h[0]]||[]).forEach(function(N){let L=N.split(".");const j=[].concat(h);j.shift(),L=L.concat(j),(I.aliases[A]||[]).includes(L.join("."))||ut(M,L,c)}),K(A,I.normalize)&&!K(A,I.arrays)&&[A].concat(I.aliases[A]||[]).forEach(function(L){Object.defineProperty(X,L,{enumerable:!0,get(){return f},set(j){f=typeof j=="string"?qt.normalize(j):j}})})}function S(A,f){I.aliases[A]&&I.aliases[A].length||(I.aliases[A]=[f],w[f]=!0),I.aliases[f]&&I.aliases[f].length||S(f,A)}function R(A,f,u){u&&(f=ks(f)),(K(A,I.bools)||K(A,I.counts))&&typeof f=="string"&&(f=f==="true");let c=Array.isArray(f)?f.map(function(h){return $(A,h)}):$(A,f);return K(A,I.counts)&&(rt(c)||typeof c=="boolean")&&(c=He()),K(A,I.normalize)&&K(A,I.arrays)&&(Array.isArray(f)?c=f.map(h=>qt.normalize(h)):c=qt.normalize(f)),c}function $(A,f){return!o["parse-positional-numbers"]&&A==="_"||!K(A,I.strings)&&!K(A,I.bools)&&!Array.isArray(f)&&(ns(f)&&o["parse-numbers"]&&Number.isSafeInteger(Math.floor(parseFloat(`${f}`)))||!rt(f)&&K(A,I.numbers))&&(f=Number(f)),f}function W(A){const f=Object.create(null);at(f,I.aliases,l),Object.keys(I.configs).forEach(function(u){const c=A[u]||f[u];if(c)try{let h=null;const N=qt.resolve(qt.cwd(),c),L=I.configs[u];if(typeof L=="function"){try{h=L(N)}catch(j){h=j}if(h instanceof Error){g=h;return}}else h=qt.require(N);G(h)}catch(h){h.name==="PermissionDenied"?g=h:A[u]&&(g=Error(_("Invalid JSON config file: %s",c)))}})}function G(A,f){Object.keys(A).forEach(function(u){const c=A[u],h=f?f+"."+u:u;typeof c=="object"&&c!==null&&!Array.isArray(c)&&o["dot-notation"]?G(c,h):(!ot(M,h.split("."))||K(h,I.arrays)&&o["combine-arrays"])&&B(h,c)})}function k(){typeof E<"u"&&E.forEach(function(A){G(A)})}function V(A,f){if(typeof m>"u")return;const u=typeof m=="string"?m:"",c=qt.env();Object.keys(c).forEach(function(h){if(u===""||h.lastIndexOf(u,0)===0){const N=h.split("__").map(function(L,j){return j===0&&(L=L.substring(u.length)),me(L)});(f&&I.configs[N.join(".")]||!f)&&!ot(A,N)&&B(N.join("."),c[h])}})}function ft(A){let f;const u=new Set;Object.keys(A).forEach(function(c){if(!u.has(c)&&(f=K(c,I.coercions),typeof f=="function"))try{const h=$(c,f(A[c]));[].concat(I.aliases[c]||[],c).forEach(N=>{u.add(N),A[N]=h})}catch(h){g=h}})}function It(A){return I.keys.forEach(f=>{~f.indexOf(".")||typeof A[f]>"u"&&(A[f]=void 0)}),A}function at(A,f,u,c=!1){Object.keys(u).forEach(function(h){ot(A,h.split("."))||(ut(A,h.split("."),u[h]),c&&(D[h]=!0),(f[h]||[]).forEach(function(N){ot(A,N.split("."))||ut(A,N.split("."),u[h])}))})}function ot(A,f){let u=A;o["dot-notation"]||(f=[f.join(".")]),f.slice(0,-1).forEach(function(h){u=u[h]||{}});const c=f[f.length-1];return typeof u!="object"?!1:c in u}function ut(A,f,u){let c=A;o["dot-notation"]||(f=[f.join(".")]),f.slice(0,-1).forEach(function(Z){Z=Or(Z),typeof c=="object"&&c[Z]===void 0&&(c[Z]={}),typeof c[Z]!="object"||Array.isArray(c[Z])?(Array.isArray(c[Z])?c[Z].push({}):c[Z]=[c[Z],{}],c=c[Z][c[Z].length-1]):c=c[Z]});const h=Or(f[f.length-1]),N=K(f.join("."),I.arrays),L=Array.isArray(u);let j=o["duplicate-arguments-array"];!j&&K(h,I.nargs)&&(j=!0,(!rt(c[h])&&I.nargs[h]===1||Array.isArray(c[h])&&c[h].length===I.nargs[h])&&(c[h]=void 0)),u===He()?c[h]=He(c[h]):Array.isArray(c[h])?j&&N&&L?c[h]=o["flatten-duplicate-arrays"]?c[h].concat(u):(Array.isArray(c[h][0])?c[h]:[c[h]]).concat([u]):!j&&!!N==!!L?c[h]=u:c[h]=c[h].concat([u]):c[h]===void 0&&N?c[h]=L?u:[u]:j&&!(c[h]===void 0||K(h,I.counts)||K(h,I.bools))?c[h]=[c[h],u]:c[h]=u}function _t(...A){A.forEach(function(f){Object.keys(f||{}).forEach(function(u){I.aliases[u]||(I.aliases[u]=[].concat(r[u]||[]),I.aliases[u].concat(u).forEach(function(c){if(/-/.test(c)&&o["camel-case-expansion"]){const h=me(c);h!==u&&I.aliases[u].indexOf(h)===-1&&(I.aliases[u].push(h),w[h]=!0)}}),I.aliases[u].concat(u).forEach(function(c){if(c.length>1&&/[A-Z]/.test(c)&&o["camel-case-expansion"]){const h=es(c,"-");h!==u&&I.aliases[u].indexOf(h)===-1&&(I.aliases[u].push(h),w[h]=!0)}}),I.aliases[u].forEach(function(c){I.aliases[c]=[u].concat(I.aliases[u].filter(function(h){return c!==h}))}))})})}function K(A,f){const u=[].concat(I.aliases[A]||[],A),c=Object.keys(f),h=u.find(N=>c.includes(N));return h?f[h]:!1}function Rt(A){const f=Object.keys(I);return[].concat(f.map(c=>I[c])).some(function(c){return Array.isArray(c)?c.includes(A):c[A]})}function Q(A,...f){return[].concat(...f).some(function(c){const h=A.match(c);return h&&Rt(h[1])})}function x(A){if(A.match(T)||!A.match(/^-[^-]+/))return!1;let f=!0,u;const c=A.slice(1).split("");for(let h=0;h<c.length;h++){if(u=A.slice(h+2),!Rt(c[h])){f=!1;break}if(c[h+1]&&c[h+1]==="="||u==="-"||/[A-Za-z]/.test(c[h])&&/^-?\d+(\.\d*)?(e-?\d+)?$/.test(u)||c[h+1]&&c[h+1].match(/\W/))break}return f}function y(A){return o["unknown-options-as-args"]&&F(A)}function F(A){return A=A.replace(/^-{3,}/,"--"),A.match(T)||x(A)?!1:!Q(A,/^-+([^=]+?)=[\s\S]*$/,C,/^-+([^=]+?)$/,/^-+([^=]+?)-$/,/^-+([^=]+?\d+)$/,/^-+([^=]+?)\W+.*$/)}function P(A){return!K(A,I.bools)&&!K(A,I.counts)&&`${A}`in l?l[A]:J(st(A))}function J(A){return{[jt.BOOLEAN]:!0,[jt.STRING]:"",[jt.NUMBER]:void 0,[jt.ARRAY]:[]}[A]}function st(A){let f=jt.BOOLEAN;return K(A,I.strings)?f=jt.STRING:K(A,I.numbers)?f=jt.NUMBER:K(A,I.bools)?f=jt.BOOLEAN:K(A,I.arrays)&&(f=jt.ARRAY),f}function rt(A){return A===void 0}function ht(){Object.keys(I.counts).find(A=>K(A,I.arrays)?(g=Error(_("Invalid configuration: %s, opts.count excludes opts.array.",A)),!0):K(A,I.nargs)?(g=Error(_("Invalid configuration: %s, opts.count excludes opts.narg.",A)),!0):!1)}return{aliases:Object.assign({},I.aliases),argv:Object.assign(X,M),configuration:o,defaulted:Object.assign({},D),error:g,newAliases:Object.assign({},w)}}}function Ys(a){const t=[],e=Object.create(null);let n=!0;for(Object.keys(a).forEach(function(s){t.push([].concat(a[s],s))});n;){n=!1;for(let s=0;s<t.length;s++)for(let i=s+1;i<t.length;i++)if(t[s].filter(function(o){return t[i].indexOf(o)!==-1}).length){t[s]=t[s].concat(t[i]),t.splice(i,1),n=!0;break}}return t.forEach(function(s){s=s.filter(function(r,o,l){return l.indexOf(r)===o});const i=s.pop();i!==void 0&&typeof i=="string"&&(e[i]=s)}),e}function He(a){return a!==void 0?a+1:1}function Or(a){return a==="__proto__"?"___proto___":a}function ks(a){return typeof a=="string"&&(a[0]==="'"||a[0]==='"')&&a[a.length-1]===a[0]?a.substring(1,a.length-1):a}/**
...
`),o=r.map((p,b)=>b===0?"AAAA":"AACA").join(";"),l={version:3,file:s,sources:[n],sourcesContent:[i],mappings:o},m=`data:application/json;base64,${Buffer.from(JSON.stringify(l),"utf-8").toString("base64")}`;this.cdp.sendMessage({method:"Debugger.scriptParsed",params:{scriptId:e,url:s,startLine:0,startColumn:0,endLine:r.length,endColumn:0,executionContextId:1,sourceMapURL:m}})}catch(i){this.cdp.sendMessage({method:"Log.entryAdded",params:{entry:{source:"other",level:"warning",text:i.message,timestamp:Date.now()}}})}}getOrCreateScriptId(t){let e=this.scriptIdByUrl.get(t);return e||(e=Es.createHash("sha256").update(String(this.nextScriptId++)).digest("hex").slice(0,16),this.scriptIdByUrl.set(t,e)),e}formatPropertyFullName(t){let e=!1,n="";for(const s of t)s==='"'||s==="\\"||s==="\0"?(n+="\\"+s,e=!0):s===" "?(n+=s,e=!0):n+=s;return(e||t.includes("'"))&&(n=`"${n}"`),n}sendDbgpCommand(t,e){const s=(this.nextTxnId++).toString();let i=`${t} -i ${s}`;return e!==void 0&&(i+=` ${e}`),this.dbgp.sendCommand(i),s}async handleCdpMessage(t){const{id:e,method:n,params:s}=t;let i={},r=!0;switch(n){case"Debugger.enable":case"Runtime.enable":i={};break;case"Debugger.setBreakpointByUrl":{const{url:o,lineNumber:l}=s;if(!o){r=!1;break}const E=this.uriFromCDPToBridge(o),m=this.uriFromBridgeToDBGP(E),p=(typeof l=="number"?l:0)+1,b=String(this.breakpoints.size+1);if(this.xdebugConnected){const w=`breakpoint_set -t line -f ${this.formatPropertyFullName(m)} -n ${p}`,D=this.sendDbgpCommand(w);this.pendingCommands.set(D,{cdpId:e,cdpMethod:n,params:{breakpointId:b,fileUri:E,lineNumber:p}}),r=!1}else this.breakpoints.set(b,{cdpId:b,xdebugId:null,fileUri:E,lineNumber:p}),i={breakpointId:b,locations:[{scriptId:this.getOrCreateScriptId(E),lineNumber:p-1,columnNumber:0}]};break}case"Debugger.removeBreakpoint":{const{breakpointId:o}=s,l=String(o),E=this.breakpoints.get(l);if(E){if(E.xdebugId&&this.xdebugConnected){const m=`breakpoint_remove -d ${E.xdebugId}`,p=this.sendDbgpCommand(m);this.pendingCommands.set(p,{cdpId:e,cdpMethod:n}),r=!1}this.breakpoints.delete(l)}i={};break}case"Debugger.resume":{this.xdebugConnected&&this.sendDbgpCommand("run"),i={};break}case"Debugger.stepOver":{this.xdebugConnected&&this.sendDbgpCommand("step_over"),i={};break}case"Debugger.stepInto":{this.xdebugConnected&&this.sendDbgpCommand("step_into"),i={};break}case"Debugger.stepOut":{this.xdebugConnected&&this.sendDbgpCommand("step_out"),i={};break}case"Debugger.pause":{this.xdebugConnected&&this.sendDbgpCommand("break"),i={};break}case"Runtime.evaluate":case"Debugger.evaluateOnCallFrame":{const o=s.expression||"",l=s.callFrameId;if(n==="Debugger.evaluateOnCallFrame"){if(l===void 0||!this.callFramesMap.has(l)){this.cdp.sendMessage({id:e,error:{code:-32e3,message:"No such call frame"}});return}if(this.callFramesMap.get(l)!==0){this.cdp.sendMessage({id:e,error:{code:-32e3,message:"Evaluation in this frame not supported"}});return}}if(this.xdebugConnected){const E=Buffer.from(o).toString("base64"),m=this.sendDbgpCommand("eval",`-- ${E}`);this.pendingCommands.set(m,{cdpId:e,cdpMethod:n}),r=!1}else i={result:{type:"undefined",value:void 0}};break}case"Runtime.getProperties":{const{objectId:o}=s,l=this.objectHandles.get(o);if(l&&this.xdebugConnected)if(l.type==="context"){const E=l.contextId??0,p=`context_get -d ${l.depth} -c ${E} -p 0 -m 32`,b=this.sendDbgpCommand(p),w={...l,currentPage:0,aggregatedProps:[]};this.objectHandles.set(o,w),this.pendingCommands.set(b,{cdpId:e,cdpMethod:n,params:{objectId:o}}),r=!1}else if(l.type==="property"){const E=l.depth,m=l.fullname,p=this.formatPropertyFullName(m),b=`property_get -d ${E} -n ${p} -p 0 -m 32`,w=this.sendDbgpCommand(b),D={...l,currentPage:0,aggregatedProps:[]};this.objectHandles.set(o,D),this.pendingCommands.set(w,{cdpId:e,cdpMethod:n,params:{parentObjectId:o}}),r=!1}else i={result:[]};else i={result:[]};break}case"Debugger.getScriptSource":{const o=s.scriptId,l=[...this.scriptIdByUrl.entries()].find(([,m])=>m===o)?.[0],E=[];l&&E.push(`Here's the full path for your convenience:
...
`)};break}default:i={};break}r&&this.cdp.sendMessage({id:e,result:i})}uriFromBridgeToCDPSyntaxHighlight(t){return`file://PHP.wasm/${t}`}uriFromBridgeToCDP(t){return t=this.scriptIdByUrl.get(t)??"",`file://placeholders/${t}`}uriFromCDPToBridge(t){const e="file://placeholders/";return[...this.scriptIdByUrl.entries()].find(([,n])=>n===t.slice(e.length))?.[0]??""}uriFromBridgeToDBGP(t){return Ot.resolve(process.cwd(),t)}uriFromDBGPToBridge(t){t=t.startsWith("file://")?t.slice(7):t;const e=t.indexOf(this.phpRoot);return e!==-1?t.slice(e):t}async handleDbgpMessage(t){if(t.init){this.breakpoints.forEach(n=>{this.handleCdpMessage({id:n.cdpId,method:"Debugger.setBreakpointByUrl",params:{url:this.uriFromBridgeToCDP(n.fileUri),lineNumber:n.lineNumber-1}})});const e=this.breakOnFirstLine?this.sendDbgpCommand("step_into"):this.sendDbgpCommand("run");this.pendingCommands.set(e,{});return}if(t.response){const e=t.response,n=e.$,s=n.command,i=n.transaction_id,r=this.pendingCommands.get(i);switch(s){case"breakpoint_set":{if(r&&r.cdpId!==void 0&&r.cdpMethod==="Debugger.setBreakpointByUrl"){const o=n.id,l=r.params;if(l){const{breakpointId:E,fileUri:m,lineNumber:p}=l;this.breakpoints.set(E,{cdpId:E,xdebugId:o,fileUri:m,lineNumber:p});const b=this.getOrCreateScriptId(m),w={breakpointId:E,locations:[{scriptId:b,lineNumber:p-1,columnNumber:0}]};this.cdp.sendMessage({id:r.cdpId,result:w})}this.pendingCommands.delete(i)}break}case"breakpoint_remove":{r&&r.cdpId!==void 0&&(this.cdp.sendMessage({id:r.cdpId,result:{}}),this.pendingCommands.delete(i));break}case"run":case"step_into":case"step_over":case"step_out":{const o=n.status;if(e["xdebug:message"]){const l=this.uriFromDBGPToBridge(e["xdebug:message"].$.filename);l&&!this.scriptIdByUrl.has(l)&&await this.sendScriptToCDP(l,this.getOrCreateScriptId(l))}if(o==="break"){const l=this.sendDbgpCommand("stack_get");this.pendingCommands.set(l,{}),this.pendingCommands.delete(i)}else(o==="stopping"||o==="stopped")&&this.cdp.sendMessage({method:"Debugger.resumed",params:{}});break}case"eval":{if(r&&r.cdpId!==void 0){let o;if(e.property){const E=e.property,m=E.$.type,p=E.$.encoding;let b=null;if(Object.prototype.hasOwnProperty.call(E,"_")?b=E._:typeof E.$value<"u"&&(b=E.$value),p==="base64"&&b!==null)try{b=Buffer.from(b,"base64").toString()}catch{}if(m==="string")o={type:"string",value:b??""};else if(m==="int"||m==="float"||m==="bool"||m==="boolen"||m==="integer"||m==="double"){let w=b;m.startsWith("int")||m==="integer"?w=parseInt(b||"0",10):m==="float"||m==="double"?w=parseFloat(b||"0"):m.startsWith("bool")&&(w=b==="1"||b==="true"),o={type:"number",value:w}}else if(m==="array"||m==="object"){const w=E.$.classname||(m==="array"?"Array":"Object"),D=String(this.nextObjectId++),_=E.$.fullname||"";this.objectHandles.set(D,{type:"property",depth:0,contextId:0,fullname:_}),o={type:"object",objectId:D,className:w,description:w}}else m==="null"?o={type:"object",subtype:"null",value:null}:o={type:"undefined",value:void 0}}else o={type:"undefined",value:void 0};const l={result:o};this.cdp.sendMessage({id:r.cdpId,result:l}),this.pendingCommands.delete(i)}break}case"context_get":case"property_get":{if(r&&r.cdpId!==void 0){const o=r.params?.objectId||r.params?.parentObjectId,l=o?this.objectHandles.get(o):null,E=e.property?.property??e.property,m=[];if(E){const p=Array.isArray(E)?E:[E];for(const b of p){const w=b.$.name||b.$.fullname||"";let D=b.$.type||"undefined";const _=b.$.children==="1",I=b.$.encoding;let T=null;if(typeof b._<"u"&&(T=b._),I==="base64"&&T!==null)try{T=Buffer.from(T,"base64").toString()}catch{}if(_){const C=b.$.classname||(D==="array"?"Array":"Object"),g=String(this.nextObjectId++),v=r.cdpMethod==="Runtime.getProperties"&&r.params?.parentObjectId&&this.objectHandles.get(r.params.parentObjectId)?.contextId||0,M=r.cdpMethod==="Runtime.getProperties"&&r.params?.parentObjectId&&this.objectHandles.get(r.params.parentObjectId)?.depth||0;this.objectHandles.set(g,{type:"property",depth:M,contextId:v,fullname:b.$.fullname||w}),m.push({name:b.$.key||w,value:{type:"object",className:C,description:C,objectId:g},writable:!1,configurable:!1,enumerable:!0})}else{let C,g;D==="string"?C=T??"":D==="int"||D==="integer"?C=parseInt(T||"0",10):D==="float"||D==="double"?C=parseFloat(T||"0"):D==="bool"||D==="boolean"?(C=T==="1"||T==="true",D="boolean"):D==="null"?(C=null,g="null"):C=T;const v={type:D==="integer"?"number":D};g&&(v.subtype=g),v.value=C,m.push({name:b.$.key||w,value:v,writable:!1,configurable:!1,enumerable:!0})}}}if(l){const p=(l.aggregatedProps||[]).concat(m),b=32;if(m.length===b){const D=(l.currentPage||0)+1,_={...l,currentPage:D,aggregatedProps:p};this.objectHandles.set(o,_);let I;if(s==="context_get"){const C=l.contextId??0;I=`context_get -d ${l.depth} -c ${C} -p ${D} -m ${b}`}else{const C=l.depth,g=l.fullname,v=this.formatPropertyFullName(g);I=`property_get -d ${C} -n ${v} -p ${D} -m ${b}`}const T=this.sendDbgpCommand(I);this.pendingCommands.set(T,{cdpId:r.cdpId,cdpMethod:r.cdpMethod,params:r.params}),this.pendingCommands.delete(i);return}else{const D={result:p};this.cdp.sendMessage({id:r.cdpId,result:D}),this.pendingCommands.delete(i)}}else{const p={result:m};this.cdp.sendMessage({id:r.cdpId,result:p}),this.pendingCommands.delete(i)}}break}case"stack_get":{if(e.stack){const o=Array.isArray(e.stack)?e.stack:[e.stack],l=[];this.callFramesMap.clear();for(const m of o){const p=this.uriFromDBGPToBridge(m.$.filename),b=this.getOrCreateScriptId(p);this.scriptIdByUrl.has(p)||(this.scriptIdByUrl.set(p,b),await this.sendScriptToCDP(p,b))}for(const m of o){const p=parseInt(m.$.level,10),b=this.uriFromDBGPToBridge(m.$.filename),w=parseInt(m.$.lineno,10),D=m.$.where&&m.$.where!=="{main}"?m.$.where:"(anonymous)",_=`frame:${p}`;this.callFramesMap.set(_,p);const I=[],T=String(this.nextObjectId++);this.objectHandles.set(T,{type:"context",contextId:0,depth:p}),I.push({type:"local",object:{objectId:T,className:"Object",description:"Local"}});const C=String(this.nextObjectId++);this.objectHandles.set(C,{type:"context",contextId:1,depth:p}),I.push({type:"global",object:{objectId:C,className:"Object",description:"Global"}}),l.push({callFrameId:_,functionName:D,location:{scriptId:this.getOrCreateScriptId(b),lineNumber:w-1,columnNumber:0},scopeChain:I,this:{type:"object",className:"Object",description:"Object",objectId:C}})}let E="pause";if(o.length>0){const m=o[0];if(m.$.filename&&m.$.lineno){const p=this.uriFromDBGPToBridge(m.$.filename),b=parseInt(m.$.lineno,10);for(const w of this.breakpoints.values())if(w.fileUri===p&&w.lineNumber===b){E="breakpoint";break}}}this.cdp.sendMessage({method:"Debugger.paused",params:{reason:E,callFrames:l,hitBreakpoints:E==="breakpoint"?[""]:[]}})}this.pendingCommands.delete(i);break}default:{r&&r.cdpId!==void 0&&(this.cdp.sendMessage({id:r.cdpId,result:{}}),this.pendingCommands.delete(i));break}}}else if(t.stream){const e=t.stream,n=e.$.type,s=e.$.encoding||"none";let i=typeof e._=="string"?e._:"";s==="base64"&&(i=Buffer.from(i,"base64").toString()),this.cdp.sendMessage({method:"Log.entryAdded",params:{entry:{source:"other",level:n==="stderr"?"error":"info",text:i,timestamp:Date.now(),stackTrace:{callFrames:[]}}}})}else t.notify}}async function ms(a){const t=a.cdpPort??9229,e=a.dbgpPort??9003,n=a.cdpHost??"localhost",s=a.phpRoot??process.cwd(),i=a.breakOnFirstLine??!1;Lt.log("Starting XDebug Bridge...");const r=new Qi(t);Lt.log("Connect Chrome DevTools to CDP at:"),Lt.log(`devtools://devtools/bundled/inspector.html?ws=${n}:${t}
`),await new Promise(p=>r.on("clientConnected",p)),await new Promise(p=>setTimeout(p,2e3)),Lt.log("Chrome connected! Initializing Xdebug receiver...");const o=new Ji(e);Lt.log(`XDebug receiver running on port ${e}`),Lt.log("Running a PHP script with Xdebug enabled...");async function l(p){const b=[],w=a.phpInstance?await a.phpInstance.listFiles(p):$t.readdirSync(p);for(const D of w){const _=Ot.join(p,D);try{(a.phpInstance?await a.phpInstance.isDir(_):$t.lstatSync(_).isDirectory())?b.push(...await l(_)):D.endsWith(".php")&&b.push(_)}catch{}}return b}const E=a.phpInstance?p=>a.phpInstance.readFileAsText(p):a.getPHPFile?a.getPHPFile:p=>$t.readFileSync(p,"utf-8"),m=await l(s);return new ds(o,r,{knownScriptUrls:m,phpRoot:s,getPHPFile:E,breakOnFirstLine:i})}const gs={Quiet:{name:"quiet",severity:xt.Fatal},Normal:{name:"normal",severity:xt.Info},Debug:{name:"debug",severity:xt.Debug}};function Zo(){return Fo(Zs(process.argv)).usage(`
...
Examples:
  ...
  xdebug-bridge --php-root /path/to/php/files      # Specify PHP root directory
		`).wrap(null).strict().parseSync()}async function ta(){const a=Zo();if(a.help)return;if(a.verbosity){const e=Object.values(gs).find(n=>n.name===a.verbosity).severity;Lt.setSeverityFilterLevel(e)}(await ms({cdpPort:9229,cdpHost:a.host,dbgpPort:a.port,phpRoot:a.phpRoot})).start()}exports.CDPServer=Qi;exports.DbgpSession=Ji;exports.XdebugCDPBridge=ds;exports.main=ta;exports.startBridge=ms;
