...
async function getIntlExtensionPath() {
  if (await (0, import_wasm_feature_detect.jspi)()) {
    return (await Promise.resolve().then(() => __toESM(require("./jspi/extensions/intl/8_0/intl.so?url"), 1))).default;
  } else {
    return (await Promise.resolve().then(() => __toESM(require("./asyncify/extensions/intl/8_0/intl.so?url"), 1))).default;
  }
}
