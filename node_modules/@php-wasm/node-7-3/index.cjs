...
// packages/php-wasm/node-builds/7-3/src/index.ts
var src_exports = {};
...
async function getPHPLoaderModule() {
  if (await (0, import_wasm_feature_detect.jspi)()) {
    return await Promise.resolve().then(() => __toESM(require("./jspi/php_7_3.js"), 1));
  } else {
    return await Promise.resolve().then(() => __toESM(require("./asyncify/php_7_3.js"), 1));
  }
}
async function getIntlExtensionPath() {
  if (await (0, import_wasm_feature_detect.jspi)()) {
    return (0, import_node_path.join)(packageDir, "jspi/extensions/intl/7_3/intl.so");
  } else {
    return (0, import_node_path.join)(packageDir, "asyncify/extensions/intl/7_3/intl.so");
  }
}
async function getXdebugExtensionPath() {
  if (await (0, import_wasm_feature_detect.jspi)()) {
    return (0, import_node_path.join)(packageDir, "jspi/extensions/xdebug/7_3/xdebug.so");
  } else {
    return (0, import_node_path.join)(packageDir, "asyncify/extensions/xdebug/7_3/xdebug.so");
  }
}
