...
async function getIntlExtensionPath() {
  if (await jspi()) {
    return join(packageDir, "jspi/extensions/intl/7_3/intl.so");
  } else {
    return join(packageDir, "asyncify/extensions/intl/7_3/intl.so");
  }
}
async function getXdebugExtensionPath() {
  if (await jspi()) {
    return join(packageDir, "jspi/extensions/xdebug/7_3/xdebug.so");
  } else {
    return join(packageDir, "asyncify/extensions/xdebug/7_3/xdebug.so");
  }
}
export {
